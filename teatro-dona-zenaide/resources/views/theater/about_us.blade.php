    ...
    <div id="about-content-section">
        <div class="container d-flex flex-column">
                ...
                <div class="row justify-content-between">
                    ...
                    {{-- Imagem Teatro --}}
                    <div class="col-md-5">
                        <img src="{{ asset('/assets/img/tela-about-us/img-sobre-teatro.png') }}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row justify-content-between">
                    ...
                    {{-- Imagem Dona Zenaide --}}
                    <div class="col-md-5">
                        <img src="{{ asset('/assets/img/tela-about-us/img-sobre-zenaide.png') }}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="mapa-de-lugares-tab-pane" role="tabpanel" aria-labelledby="mapa-de-lugares-tab" tabindex="0">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-md-5">
                                <img src="{{ asset('/assets/img/tela-about-us/img-mapa-de-lugares.png') }}" class="img-fluid" alt="">
                            </div>
                            <div class="col-md-5">
                    ...
                    <div class="tab-pane fade" id="hall-tab-pane" role="tabpanel" aria-labelledby="hall-tab" tabindex="0">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-md-5">
                                <img src="{{ asset('/assets/img/tela-about-us/img-hall.jpeg') }}" class="img-fluid" alt="">
                            </div>
                            <div class="col-md-5">
                                <ul class="technical-characteristics-ul d-flex flex-column">
                                    <li class="roboto-regular">Excelente lugar para <span class="technical-characteristics-text-highlight">exposições</span></li>
                    ...
                    <div class="tab-pane fade" id="palco-tab-pane" role="tabpanel" aria-labelledby="palco-tab" tabindex="0">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-md-5">
                                <img src="{{ asset('/assets/img/tela-about-us/img-palco.jpeg') }}" class="img-fluid" alt="">
                            </div>
                            <div class="col-md-5">
                                <ul class="technical-characteristics-ul d-flex flex-column">
                    ...
                    <div class="tab-pane fade" id="equipamento-de-luz-tab-pane" role="tabpanel" aria-labelledby="equipamento-de-luz-tab" tabindex="0">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-md-5">
                                <img src="{{ asset('/assets/img/tela-about-us/img-equipamento-de-luz.jpeg') }}" class="img-fluid" alt="">
                            </div>
                            <div class="col-md-5">
                                <ul class="technical-characteristics-ul d-flex flex-column">
