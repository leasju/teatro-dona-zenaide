                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <li class="page-item active" aria-current="page"><span class="page-link"><span class="page-link-hover">{{ $page }}</span></span></li>
                                @else
                                    <li class="page-item"><a class="page-link" href="{{ $url }}"><span class="page-link-hover">{{ $page }}</span></a></li>
                                @endif
                            @endforeach
                        @endif
                    @endforeach
