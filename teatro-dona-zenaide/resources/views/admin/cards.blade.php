            ...
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div id="table-cards-box" class="col-md-12">
                    ...
                    <div class="table-top-content d-flex justify-content-between align-items-center mb-5">
                        {{-- Título da Tabela --}}
                        <h1 class="roboto-regular">Crie, Edite, Remova ou Altere a Visualização de uma Peça</h1>

                        <div id="table-top-buttons" class="d-flex gap-2">
                            
                            {{-- Filtros em Dropdown --}}
                            <div class="dropdown">

                                <button class="main-btn main-btn--filter dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
