...
@section('content')
    ...
    {{-- * New Modal --}}
    <x-admin.modal modalclasswidth="modal-lg" id="newModal" modalclass="neweditModal" labelledby="newModalLabel" title="Adicionar Nova Peça">
    ...
    <x-admin.modal modalclasswidth="modal-lg" id="editModal" modalclass="neweditModal" labelledby="editModalLabel" title="Editar Peça">

        {{-- Conteúdo do Modal --}}
        <x-slot name="content">

            {{-- Form Edit --}}
            <form action="/admin/cards/edit" method="POST" enctype="multipart/form-data">

                @csrf
                @method('PUT') {{-- Usar o método PUT para edição --}}

                <div class="accordion" id="accordionFormEdit">

                    {{-- * Collapse 1: Informações da Peça --}}
                    <div class="accordion-item">

                        {{-- Header do Collapse 1 --}}
                        <h2 class="accordion-header" id="editHeadingOne">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#editCollapseInformacoesPeca" aria-expanded="true" aria-controls="editCollapseInformacoesPeca">
                                Informações da Peça
                            </button>
                        </h2>

                        {{-- Conteúdo do Collapse 1: Informações da Peça --}}
                        <div id="editCollapseInformacoesPeca" class="accordion-collapse collapse" aria-labelledby="editHeadingOne" data-bs-parent="#accordionFormEdit">
                            <div class="accordion-body">
                                ...
                                <div class="mb-3 d-flex flex-column gap-2">
                                    ...
                                    @foreach(['Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado'] as $day)
                                        ...
                                        <div class="form-check ms-2">
                                            {{-- Checkbox para cada dia da semana, com o valor sendo o nome do dia (ex: Domingo) --}}
                                            <input class="edit-form-check-input form-check-input checkbox-day" type="checkbox" value="{{ $day }}" id="check{{ $day }}" name="days[]">
                                        ...
                                        {{-- Div que contém os campos de horário para o respectivo dia de apresentação --}}
                                        {{-- Inicialmente está oculta (classe d-none) e só será exibida quando o checkbox correspondente for marcado --}}
                                        <div id="edit-schedules-{{ $day }}" class="mt-2 ms-2 d-none">
                                            {{-- Div para agrupar os inputs de horário --}}
                                            <div class="edit-schedule-wrapper mb-3">
                                                <div class="d-flex align-items-center mb-2">
                                                    {{-- Input para inserir o horário da sessão (formato de tempo) --}}
                                                    <input type="time" class="form-control me-2" name="edit-schedules[{{ $day }}][]" placeholder="Horário">
                                                </div>
                                            </div>

                                            {{-- Botão para adicionar mais horários para o respectivo dia de apresentação --}}
                                            {{-- O atributo "day-date" contém o nome do dia, para que o JavaScript saiba a qual dia esse botão se refere --}}
                                            <button type="button" class="btn edit-btn-add-schedule add-schedule d-flex align-items-center mb-3" day-date="{{ $day }}">
                                                <span class="ic--baseline-plus"></span>
                                                <span class="roboto-regular">Novo horário</span>
                                            </button>
                                        </div>
                    ...
                    {{-- * Collapse 2: Imagens da Peça --}}
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="editHeadingTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#editCollapseImagensPeca" aria-expanded="false" aria-controls="editCollapseImagensPeca">
                                Imagens da Peça
                            </button>
                        </h2>
                        <div id="editCollapseImagensPeca" class="accordion-collapse collapse" aria-labelledby="editHeadingTwo" data-bs-parent="#accordionFormEdit">
                            <div class="accordion-body">
                                {{-- Inputs de Imagem da Peça (Card) --}}
                                <div class="mb-3">
                                    <label for="imagemPrincipal" class="form-label">Imagem do Cartão Principal da Peça <span class="red-star" title="Campo obrigatório">*</span></label>
                                    <input type="file" class="form-control" id="imagemPrincipal" name="imagemPrincipal" accept="image/*" aria-label="Escolher arquivo" required>
                                    <small class="text-muted">Formatos de imagem aceitos: .jpeg, .jpg, .png, .bmp, .gif, .svg ou .webp</small>
                                </div>
                    ...
                    {{-- * Collapse 3: Ficha Técnica --}}
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="editHeadingThree">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#editCollapseFichaTecnica" aria-expanded="false" aria-controls="editCollapseFichaTecnica">
                                Ficha Técnica
                            </button>
                        </h2>
                        <div id="editCollapseFichaTecnica" class="accordion-collapse collapse" aria-labelledby="editHeadingThree" data-bs-parent="#accordionFormEdit">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        ...
                        {{-- Header do Collapse 4 --}}
                        <h2 class="accordion-header" id="headingFour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#editCollapseOpcionaisFichaTecnica" aria-expanded="false" aria-controls="editCollapseOpcionaisFichaTecnica">
                                Opcionais (Ficha Técnica)
                            </button>
                        </h2>

                        {{-- Conteúdo do Collapse 4: Opcionais (Ficha Técnica) --}}
                        <div id="editCollapseOpcionaisFichaTecnica" class="accordion-collapse collapse" aria-labelledby="editHeadingFour" data-bs-parent="#accordionFormEdit">
                            <div class="accordion-body">
    ...
    {{-- * Delete Modal --}}
    <x-admin.modal modalclasswidth="" modalclass="" id="deleteModal" labelledby="deleteModalLabel" title="Deletar Peça">
    ...
    {{-- * Visibility Modal --}}
    <x-admin.modal modalclasswidth="" modalclass="" id="visibilityModal" labelledby="visibilityModalLabel" title="Esconder Peça">
